<nav class="navbar p-0 fixed-top d-flex flex-row">
    <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
        <a class="navbar-brand brand-logo-mini" href="<?=base_url()?>index.html"><img
                src="<?=base_url()?>assets/images/logo-mini.svg" alt="logo" style="width: 100%;" /></a>
    </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                    ...
                    <a class="dropdown-item preview-item" href="<?=base_url('setting');?>">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item preview-item" href="<?php echo site_url('auth/logout'); ?>">
                        <div class="preview-thumbnail">
                            <div class="preview-icon bg-dark rounded-circle">
